---
title: "Beyond Vibe Coding: How We Ship Production Code with 200 Autonomous AgentsWhat we learned orchestrating 200+ Claude Code instances on a shared codebase: two LLM primitives, three nested failure loops, and checkpoint-based execution.Mar 18, 2026 · 42 min"
...
- **Blog:** AgentField
- **URL:** https://agentfield.ai/blog/beyond-vibe-coding
- **Fetched:** 2026-07-26
- **Extracted title:** Beyond Vibe Coding: How We Ship Production Code with 200 Autonomous Agents

## Article Content

Beyond Vibe Coding: How We Ship Production Code with 200 Autonomous Agents — AgentField
...
RETRY_MODIFIEDRelax acceptance criteria, record the gap as typed debt

RETRY_APPROACHSame criteria, different strategy ("use a different library")

SPLITBreak the issue into smaller sub-issues

ACCEPT_WITH_DEBTClose enough; record each gap as typed, severity-rated debt

ESCALATE_TO_REPLANCannot be fixed locally; restructure the remaining work
...
Debt gate: process completed-with-debt results, propagate debt_notes downstream

Split gate: if any issue was split, inject sub-issues into remaining levels
