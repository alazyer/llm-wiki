...
Agent evaluation and observability covers eval design, benchmark construction, production traces, LLM-as-judge workflows, regression testing, human judgment loops, and feedback systems for improving non-deterministic agents.
...
- [[loop-engineering]] — Evaluation and observability are the verification side of agent loops.
- [[agent-platform-operations]] — Runtime platforms generate the traces and governance signals evals consume.
